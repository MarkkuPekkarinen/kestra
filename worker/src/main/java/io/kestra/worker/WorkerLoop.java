...
/**
 * Abstract base class for implementing a worker loop that continuously processes tasks.
 * <p>
...
public abstract class WorkerLoop implements Runnable {
    ...
    /**
     * Stops the WorkerLoop gracefully.
     * <p>
     ...
     * <p>
     * This method is thread-safe and synchronized to prevent concurrent stop calls.
     */
